...
final class Etiona {
	...
	public static void main(final String[] args) {
		new DataFile().setBackground("Background2-res.png").addPlayer(2300, "Y alpha", new Color(50, 100, 50), 0)
			...
			.addCity(new City(1.001, "CityIcons/medieval(1).png", "San morir", 0, 25000, 2000, 93, 89, 5000,
				1.02,
			...
			.addCity(new City(1.2, "CityIcons/medieval.png", "Initia de aqa", 1, 15000, 7500, 43, 173, 210,
				1.02,
