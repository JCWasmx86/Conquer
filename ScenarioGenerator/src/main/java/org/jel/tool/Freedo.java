...
public class Freedo {
	...
	public static void main(final String[] args) {
		new DataFile().setBackground("Background4-res.png").addPlayer(4500, "Rhomortina", new Color(255, 255, 200), 0)
			...
			.addCity(new City(1.03, "CityIcons/architecture-and-city.png", "Rhomortina", 0, 230000, 2300, 140, 65,
				2700, 1.05, List.of(1.1, 0.8, 1.3, 1.1, 0.8, 1.1, 0.9, 0.5, 1.4)))
			.addCity(new City(1.07, "CityIcons/fortress.png", "Nisentara", 0, 14000, 12000, 126, 226, 1240, 1.01,
			...
			.addCity(new City(1.02, "CityIcons/medieval(1).png", "Medianes", 2, 2000, 40, 173, 515, 120, 1.001,
			...
			.addCity(new City(1.03, "CityIcons/fortress(1).png", "Argo", 4, 62500, 7500, 381, 120, 920, 1.003,
