...
final class UpgradeSoldiersOffense extends JPanel implements ActionListener {
	 ...
	 */
	UpgradeSoldiersOffense(final IClan clan, final ConquerInfo game) {
		this.clan = clan;
		this.game = game;
	...
	private void initUpgradeMax() {
		...
		final var count = Shared.maxLevelsAddOffenseDefenseUpgrade(this.clan.getSoldiersOffenseLevel() + 1,
				this.clan.getCoins());
