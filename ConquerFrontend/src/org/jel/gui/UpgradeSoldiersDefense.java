...
final class UpgradeSoldiersDefense extends JPanel implements ActionListener {
	...
	private String getOneLevelString() {
		return Messages.getMessage("Shared.upgradeToLevel", (this.clan.getSoldiersDefenseLevel() + 1),
				Utils.format(clan.upgradeCosts(SoldierUpgrade.DEFENSE, this.clan.getSoldiersDefenseLevel() + 1)));
	}
	...
	private void initUpgradeMax() {
		...
		final var count = clan.maxLevels(SoldierUpgrade.DEFENSE, this.clan.getSoldiersDefenseLevel() + 1,
				this.clan.getCoins());
	...
	private void initUpgradeOnce() {
		...
		final var costs = clan.upgradeCosts(SoldierUpgrade.DEFENSE, this.clan.getSoldiersDefenseLevel() + 1);
