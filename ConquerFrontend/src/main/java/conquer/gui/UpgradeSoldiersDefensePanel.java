 ...
 */
final class UpgradeSoldiersDefensePanel extends UpgradePanel {
	@Serial
	private static final long serialVersionUID = -681006129127926269L;

	public UpgradeSoldiersDefensePanel(final IClan clan) {
		super(clan);
	}
	...
	void initUpgradeMax() {
		...
		this.upgradeMax.setAction(new AbstractAction() {
			...
			public void actionPerformed(final ActionEvent e) {
				UpgradeSoldiersDefensePanel.this.clan.upgradeSoldiersDefenseFully();
			}
		});
	...
	void initUpgradeOnce() {
		...
		this.upgradeOnce.setAction(new AbstractAction() {
			...
			@Override
			public void actionPerformed(final ActionEvent e) {
				UpgradeSoldiersDefensePanel.this.clan.upgradeSoldiersDefense();
			}
		});
