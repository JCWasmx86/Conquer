...
public class Updater {
    ...
    public static void update() {
        ...
        try {
            INSTANCE.downloadFile(new URL("https://raw.githubusercontent.com/JCWasmx86/JCWasmx86.github.io/master/conquer-data/" + (System.getProperty("os.name").toLowerCase().contains("win1") ? "windows" : "linux") + ".zip"), Shared.UPDATE_DIRECTORY + System.getProperty("file.separator") + "data.zip");
