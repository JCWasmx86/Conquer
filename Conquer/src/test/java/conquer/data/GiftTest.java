...
class GiftTest {
	...
	void testNegativeCoins() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> new Gift(null, -1));
	}
	...
	void testNotEnoughResources() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> new Gift(List.of(), 50));
	}

	@Test
	void testNullResources() {
		Assertions.assertThrows(IllegalArgumentException.class, () -> new Gift(null, 50));
	}
